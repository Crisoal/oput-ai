/*
  ...
  1. Data Population
    - Insert sample scholarship, fellowship, and grant opportunities
    - Populate all required fields according to the opportunities table schema
    - Include diverse opportunities from different countries and fields
    - Set realistic funding amounts and deadlines

  2. Data Coverage
    - Multiple academic levels (graduate, phd)
    - Various fields (Computer Science, Engineering, Physics, Medicine, etc.)
    - Different countries (US, Germany, UK, Canada, China, etc.)
    - Different opportunity types (scholarship, fellowship, grant)
*/
