/*
  # Update opportunities with current 2025 deadlines

  1. Data Updates
    - Clear existing sample data
    - Insert current opportunities with 2025 deadlines
    - Add cybersecurity-focused opportunities for Nigerian students
    - Ensure all deadlines are current and non-expired

  2. Data Quality
    - Realistic citizenship requirements
    - Legitimate scholarship programs
    - Proper GPA requirements and language proficiency levels
*/
