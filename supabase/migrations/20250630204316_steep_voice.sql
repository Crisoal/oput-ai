/*
  ...
  1. Sample Data
    - Insert 12 diverse educational opportunities
    - Include scholarships, fellowships, and grants
    - Cover various fields, levels, and countries
    - Provide realistic funding amounts and requirements

  2. Data Coverage
    - Academic levels: undergraduate, graduate, phd, postdoc
    - Fields: Computer Science, Engineering, Medicine, Physics, Various
    - Countries: United States, Germany, United Kingdom, Canada, China, etc.
    - Types: scholarship, fellowship, grant
*/
