/*
  ...
  1. Purpose
    - Insert realistic scholarship and fellowship opportunities
    - Provide diverse options across different fields and countries
    - Enable testing of the matching algorithm

  2. Data Structure
    - Uses existing opportunities table schema
    - Includes various academic levels and fields
    - Covers multiple countries and funding amounts
*/
...
(
  ...
  '2024-12-01',
  '40000',
  'Academic transcripts, Research statement, Letters of recommendation, Publications',
  '{"research_excellence": true, "innovation": true}',
  3.8,
  ARRAY['Any'],
  '{"english": "C1"}'
),
(
  ...
  '2024-09-25',
  '42000',
  'Academic transcripts, Research proposal, Letters of recommendation, Technical portfolio',
  '{"technical_excellence": true, "research_potential": true}',
  3.7,
  ARRAY['Any'],
  '{"english": "C1"}'
),
(
  ...
  '2024-11-15',
  '35000',
  'Academic transcripts, Research proposal, Letters of recommendation, Language certificate',
  '{"academic_excellence": true, "research_potential": true}',
  3.5,
  ARRAY['Any except Switzerland'],
  '{"english": "B2", "german": "B1", "french": "B1"}'
);